...
export default function Header() {
    return (
        <section className={'fixed top-0 z-20 w-full flex items-center h-16  shadow-sm bg-white dark:bg-gray-950 inset-shadow-gray-950 transition-colors duration-300'}>
